...
// Get the number of games by accessing the length of the GAMES_JSON array
...
topPledgeGame.textContent = `${topGame.name}`;
firstGameContainer.appendChild(topPledgeGame);

// do the same for the runner up item
const runnerUpItem = document.createElement('p');
